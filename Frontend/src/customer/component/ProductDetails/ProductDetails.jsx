...
import { Rating,Button, Box, LinearProgress } from '@mui/material'
          ...
          <div className="flex flex-wrap space-x-5 justify-center">
           { product.images.map((item)=> <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
            ...
            />
              ...
              {/* Product info */}
        <div className="lg:col-span-1 maxt-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
         ...
         {/* Creating Another Section for ratings and reviews */}
         <section>
